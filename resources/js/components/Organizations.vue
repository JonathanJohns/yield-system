<template>
    ...
    <div class="container-fluid">
        ...
        <div class="col-8">
            ...
            <h2 class="text-secondary"> All Organizations
            ...
            <vue-good-table
              ...
              styleClass="vgt-table striped bordered condensed text-center"
                ...
                <template slot="table-row" slot-scope="props">
                    ...
                    <router-link class="text-dark" :to="'/printers/' + props.row.org_id">{{props.row.name}}</router-link>
                    </span>
...
syntaxHighlight(json) {
  ...
  return [key, data.objects[key]];
			...
			console.log('reutrrrrn', result[1][1].fields.name);
            var final = []
